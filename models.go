...
type Post struct {
	...
	Description *string   `json:"description"` // pointer to string: if it's nil, then it will marshal to what you would expect in json language, which is null
